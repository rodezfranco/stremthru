...
CREATE INDEX IF NOT EXISTS "torrent_stream_idx_asid" ON "torrent_stream" ("asid" text_pattern_ops);
CREATE INDEX IF NOT EXISTS "torrent_stream_idx_sid" ON "torrent_stream" ("sid" text_pattern_ops);
-- +goose StatementEnd
